                    ...
                    Object(c.a)(
                        {
                            ...
                            methods: {
                                ...
                                getPreviousRecord: function () {
                                    var a = this;
                                    this.loadPrevErrors(a);
                                },
                                getNextRecord: function () {                              
                                    var a = this;
                                    this.loadNextErrors(a);
                                ...
                                loadPrevErrors: function (a) {
                                    ...
                                    if (currentPage > 1) {
                                        ...
                                        H.a
                                            .get((window.$elmah_root || "/elmah") + "/api/errors?p=" + currentPage + "&s=" + size + "&i=" + skip)
                                            .then(function (b) {
                                                b.data &&
                                                    b.data.errors &&
                                ...
                                loadNextErrors: function (a) {
                                    var c = this,
                                        b = a.items.length > 0 ? a.items[0].id : "";
                                    currentPage = currentPage + 1;
                                    var skip = (currentPage - 1) * size;
                                    var totalPages = Math.ceil((this.totalCount) / size);
                        ...
                        function () {
                            ...
                            return a("div", { staticClass: "" }, [
                                a(
                                    "div",
                                    { staticClass: "table-responsive table-scroll table-bordered", class: {}, attrs: { id: "" }, on: {} },
                                    [
                                        a("table", { staticClass: "table table-striped", class: {}, attrs: { id: "" }, on: {} }, [
                                            a("thead", { staticClass: "thead-light", class: {}, attrs: { id: "" }, on: {} },
                                                [
                                                    a("tr",
                                                        [
                                                            a("th", [_c._v("Source")]),
                                                            a("th", [_c._v("Status Code")]),
                                                            a("th", [_c._v("Error Type")]),
                                                            a("th", [_c._v("Error Message")]),
                                                            a("th", [_c._v("User")]),
                                                            a("th", [_c._v("Application Name")]),
                                                            a("th", [_c._v("DateTime")]),
                                                            a("th", [_c._v("Show Details")]),
                                                        ])
                                                ]
                                            ...
                                            a(
                                                ...
                                                [
                                                    this.items && this.items.length > 0 ?
                                                        this._l(this.items, function (c, d) {
                                                            return [
                                                                a("tr",
                                                                    [
                                                                        a("td", [_c._v(c.error.source == "" ? "N/A" : c.error.source)]),
                                                                        a("td", [_c._v(c.error.statusCode)]),
                                                                        a("td", [_c._v(c.error.type)]),
                                                                        a("td", [_c._v(c.error.message)]),
                                                                        a("td", [_c._v(c.error.user)]),
                                                                        a("td", [_c._v(c.error.applicationName)]),
                                                                        a("td", [_c._v(c.error.time)]),
                                                                        a("td",
                                                                            [
                                                                                a("a", { staticClass: "", attrs: { type: "link", target: "_blank", href: (a.elmah_root || "/elmah") + "/detail/" + c.id, title: "View Details" } }, [
                                                                                    a("span", [_c._v("Details")]),
                                                                                ]),
                                                                            ]
                                                                        ),
                                                                    ])
                                ...
                                a("div", { staticClass: "container-fluid" },
                                    [
                                        a("div", { staticClass: "row" }, [
                                            a("div", { staticClass: "col-lg-6 total-count" }, [this._v("Loaded "), a("span", [this._v(this._s(this.items.length))]), this._v(" of "), a("span", [this._v(this._s(this.totalCount))]), this._v(" errors")]),
                                            a("div", { staticClass: "col-lg-3 total-count" },
                                                [a("span", [this._v("Page " + currentPage + " of "), this._v(totalPages)])]
                                            ),
                                            a(
                                                "div",
                                                { staticClass: "col-lg-3 total-count", class: {}, attrs: { id: "" }, on: {} },
                                                [
                                                    a("a", { staticClass: "ml-5 mr-4", attrs: { type: "link", title: "Previous Page", href: "javascript:void(0)" }, on: { click: this.getPreviousRecord } }, [
                                                        a("span", [this._v("Previous Page")]),
                                                    ]),
                                                    a("a", { staticClass: "ml-5", attrs: { type: "link", title: "Next Page", href: "javascript:void(0)" }, on: { click: this.getNextRecord } }, [
                                                        a("span", [this._v("Next Page")]),
                                                    ]),
                                                ],
                                                2
                                            ),
