...
namespace ElmahCore
{
    ...
    class SpeedBar
    {
            ...
            return new HelperResult(writer =>
            {
                ...
                foreach (var item in items)
                {
                    ...
                    foreach (var part in item.Render())
                        writer.Write(ElmahCore.Html.Encode(part).ToHtmlString());
                    writer.Write("</li>");
                }
                writer.Write("</ul>");
            });
        ...
        public sealed class FormattedItem : Item
        {
            ...
            {
                yield return ElmahCore.Html.Raw(@"<a ");
                yield return ElmahCore.Html.Raw(@" href='");
                yield return Href;
                yield return ElmahCore.Html.Raw(@"' title='");
                yield return Title;
                yield return ElmahCore.Html.Raw(@"'>");
                yield return Text;
                yield return ElmahCore.Html.Raw(@"</a>");
            }
        }
